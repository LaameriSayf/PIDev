 ...
 */
final class Version20240219173457 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE blog (id INT AUTO_INCREMENT NOT NULL, categorieblogs_id INT DEFAULT NULL, id_user_id INT DEFAULT NULL, titre VARCHAR(255) DEFAULT NULL, description VARCHAR(2555) DEFAULT NULL, datepub DATETIME DEFAULT NULL, image VARCHAR(2555) DEFAULT NULL, lieu VARCHAR(255) DEFAULT NULL, rate DOUBLE PRECISION DEFAULT NULL, INDEX IDX_C0155143A20B1463 (categorieblogs_id), INDEX IDX_C015514379F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, idblog_id INT DEFAULT NULL, id_user_id INT DEFAULT NULL, contenue VARCHAR(2555) DEFAULT NULL, jaime TINYINT(1) DEFAULT NULL, nejaimepas TINYINT(1) DEFAULT NULL, INDEX IDX_67F068BC5E42CF9 (idblog_id), INDEX IDX_67F068BC79F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE global_user (id INT AUTO_INCREMENT NOT NULL, cin INT DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, genre TINYINT(1) DEFAULT NULL, datenaissance DATETIME DEFAULT NULL, numtel INT DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, password VARCHAR(255) DEFAULT NULL, interlock TINYINT(1) DEFAULT NULL, Role VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8CC4E625ABE530DA (cin), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE medecin (id INT NOT NULL, specialite VARCHAR(255) DEFAULT NULL, etat TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE patient (id INT NOT NULL, numcarte INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pharmacien (id INT NOT NULL, poste TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE commentaire ADD CONSTRAINT FK_67F068BC79F37AE5 FOREIGN KEY (id_user_id) REFERENCES global_user (id)');
        $this->addSql('ALTER TABLE medecin ADD CONSTRAINT FK_1BDA53C6BF396750 FOREIGN KEY (id) REFERENCES global_user (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE patient ADD CONSTRAINT FK_1ADAD7EBBF396750 FOREIGN KEY (id) REFERENCES global_user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE pharmacien ADD CONSTRAINT FK_59E396F3BF396750 FOREIGN KEY (id) REFERENCES global_user (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pharmacien DROP FOREIGN KEY FK_59E396F3BF396750');
