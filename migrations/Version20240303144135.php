 ...
 */
final class Version20240303144135 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE global_user ADD image VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE ordonnance CHANGE medecamentprescrit medecamentprescrit VARCHAR(25555) DEFAULT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1ADAD7EBD68F8608 ON patient (numcarte)');
