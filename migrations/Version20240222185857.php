 ...
 */
final class Version20240222185857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dossiermedical DROP antecedantpersonnelles, CHANGE resultatexamen resultatexamen VARCHAR(25555) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dossiermedical ADD antecedantpersonnelles JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', CHANGE resultatexamen resultatexamen MEDIUMTEXT DEFAULT NULL');
