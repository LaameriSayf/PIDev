 ...
 */
final class Version20240222184304 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dossiermedical (id INT AUTO_INCREMENT NOT NULL, patient_id INT DEFAULT NULL, resultatexamen VARCHAR(25555) DEFAULT NULL, antecedantpersonnelles JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', UNIQUE INDEX UNIQ_6699B4F06B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ordonnance (id INT AUTO_INCREMENT NOT NULL, patient_id INT DEFAULT NULL, dossier_id INT DEFAULT NULL, renouvellement DATE NOT NULL, medecamentprescrit VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, dateprescription DATE NOT NULL, INDEX IDX_924B326C6B899279 (patient_id), INDEX IDX_924B326C611C0C56 (dossier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
