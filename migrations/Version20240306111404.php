 ...
 */
final class Version20240306111404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patient ADD dossier_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE patient ADD CONSTRAINT FK_1ADAD7EB611C0C56 FOREIGN KEY (dossier_id) REFERENCES dossiermedical (id)');
